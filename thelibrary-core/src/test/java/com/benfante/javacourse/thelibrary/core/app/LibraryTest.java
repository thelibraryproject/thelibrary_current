...
public class LibraryTest {
	...
	public void setupTests() {
		...
		Author rowling = new Author(0L, "J.K.", "Rowling");
		Book b1 = new Book(1L, "Harry Potter", rowling);
		library.addBook(b1);
		Author christie = new Author(1L, "Agatha", "Christie");
		Book b2 = new Book(2L, "Dieci Piccoli Indiani", christie, new BigDecimal("12.20"));
		library.addBook(b2);
		Book b3 = new Book(3L, "Assassinio sull'Orient Express", christie, new BigDecimal("10.20"));
		library.addBook(b3);
	}
	...
	public void testAddBook() {
		...
		library.addBook(new Book(0L, "A book for testing", new Author[0]));
		assertEquals(previousSize + 1, library.books.size());
	}

	@Test
	public void testRemoveBook() {
		Book book = new Book(0L, "A book for testing", new Author[0]);
	...
	public void testSearchBooksByAuthor() {
		Book[] result = library.searchBooksByAuthor(new Author(1L, "not", "important"));
	...
	public void testReadBooks() throws IOException {
		...
		assertEquals(Long.valueOf(1), booksAsArray[0].getId());
	...
	public void testWriteGof() throws IOException {
		Book book = new Book(5L, "Design Patterns",
				new Author[] {
						new Author(3L, "Erich", "Gamma"),
						new Author(4L, "Richard", "Helm")
				},
